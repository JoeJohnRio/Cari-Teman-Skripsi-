...
class FilterDialog : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewBind = DataBindingUtil.setContentView(this, R.layout.dialog_filter)
        ...
        viewBind.bTypeFilterPkl.setOnClickListener{
            toggleTurnOf(viewBind.bTypeFilterPkl, viewBind.bTypeFilterLomba, viewBind.bTypeFilterTempatPkl, R.color.navy_blue, R.color.white_low)
        }
        viewBind.bTypeFilterLomba.setOnClickListener{
            toggleTurnOf(viewBind.bTypeFilterLomba, viewBind.bTypeFilterPkl, viewBind.bTypeFilterTempatPkl, R.color.navy_blue, R.color.white_low)
        }
        viewBind.bTypeFilterTempatPkl.setOnClickListener{
            toggleTurnOf(viewBind.bTypeFilterTempatPkl, viewBind.bTypeFilterPkl, viewBind.bTypeFilterLomba, R.color.navy_blue, R.color.white_low)
        }
