...
class NotifikasiMemintaPertemananViewHolder(override val containerView: View) :
    ...
    fun bind(
        ...
        tvDescNotifikasi?.setText("${response.mahasiswa?.name} ingin berteman dengan anda")
