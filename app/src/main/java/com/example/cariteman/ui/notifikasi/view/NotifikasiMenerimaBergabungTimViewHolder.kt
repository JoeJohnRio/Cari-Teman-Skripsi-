...
class NotifikasiMenerimaBergabungTimViewHolder(override val containerView: View) :
    ...
    fun bind(
        ...
        tvDescNotifikasi?.setText("${response.mahasiswa?.name} bergabung dengan tim anda")
