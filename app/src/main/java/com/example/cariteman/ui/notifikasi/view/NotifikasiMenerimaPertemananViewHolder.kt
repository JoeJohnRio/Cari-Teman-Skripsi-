...
class NotifikasiMenerimaPertemananViewHolder(override val containerView: View) :
    ...
    fun bind(
        ...
        tvDescNotifikasi?.setText("${response.mahasiswa?.name} menerima permintaan berteman anda")
