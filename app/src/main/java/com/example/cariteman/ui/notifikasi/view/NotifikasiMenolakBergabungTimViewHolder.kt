...
class NotifikasiMenolakBergabungTimViewHolder(override val containerView: View) :
    ...
    fun bind(
        ...
        tvDescNotifikasi?.setText("${response.mahasiswa?.name} menolak untuk bergabung dalam tim")
